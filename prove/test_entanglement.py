...
params= hqga_utils.Parameters(base=4,pop_size=3, max_gen=1, prob_mut=0.3,elitism="Quantistic_elitism")
...
for gen in l_gen:
    ...
    list_qubit_gate, list_qubit_entang, list_qubit_mutation, list_qubit_X = hqga_utils.computeLists(circuit, index_best,
                                                                                                    params.pop_size,
